...
const _employees = [
  EmployeePerformance(
    ...
    imagePath: 'assets/images/people/sarah.png',
  ...
  EmployeePerformance(
    ...
    imagePath: 'assets/images/people/alex.png',
    tags: ['AWS', 'GCP'],
  ),
  EmployeePerformance(
    name: 'John Miller',
    ...
    imagePath: 'assets/images/people/john.png',
    tags: ['CI/CD', 'Docker'],
  ),
  EmployeePerformance(
    name: 'Elena R.',
    ...
    imagePath: 'assets/images/people/elena.png',
    tags: ['Figma', 'Design'],
  ),
  EmployeePerformance(
    name: 'Omar Sayed',
    ...
    imagePath: 'assets/images/people/omar.png',
    tags: ['ML', 'Python'],
  ),
];
